...
export type UserPasswordDB = z.infer<typeof UserPasswordDBSchema>;
export type UserAuthProviderDB = z.infer<typeof UserAuthProviderDBSchema>;
export type UserSecurityDB = z.infer<typeof UserSecurityDBSchema>;
