...
export const FeatureFlagDBSchema = BaseEntityDBSchema.extend({
  ...
  rules: z.array(z.object({
    ...
    operator: z.enum(['equals', 'not_equals', 'contains', 'greater_than', 'less_than']).nullable(),
...
export type WebhookDelivery = z.infer<typeof WebhookDeliveryDBSchema>;
