...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  try {
    ...
    await db.schema
      ...
      .addForeignKeyConstraint('fk_collection_type_configs_organization', ['organization_id'], 'organizations', ['id'])
      .onDelete('cascade')
      .execute();

    await db.schema
      .alterTable('collection_type_configs')
      .addForeignKeyConstraint('fk_collection_type_configs_created_by', ['created_by'], 'users', ['id'])
      .onDelete('restrict')
      .execute();
    ...
    await db.schema
      ...
      .addForeignKeyConstraint('fk_collections_organization', ['organization_id'], 'organizations', ['id'])
      .onDelete('cascade')
      .execute();
    ...
    await db.schema
      .alterTable('collections')
      .addForeignKeyConstraint('fk_collections_parent', ['parent_collection_id'], 'collections', ['id'])
      .onDelete('set null')
      .execute();
    ...
    await db.schema
      .alterTable('collections')
      .addForeignKeyConstraint('fk_collections_last_activity_user', ['last_activity_user_id'], 'users', ['id'])
      .onDelete('set null')
      .execute();
    ...
    await db.schema
      ...
      .addForeignKeyConstraint('fk_collection_items_collection', ['collection_id'], 'collections', ['id'])
      .onDelete('cascade')
      .execute();

    await db.schema
      .alterTable('collection_items')
      .addForeignKeyConstraint('fk_collection_items_created_by', ['created_by_user_id'], 'users', ['id'])
      .onDelete('restrict')
      .execute();

    await db.schema
      .alterTable('collection_items')
      .addForeignKeyConstraint('fk_collection_items_action_assigned', ['action_assigned_to'], 'users', ['id'])
      .onDelete('set null')
      .execute();
    ...
    await db.schema
      .alterTable('collection_items')
      .addForeignKeyConstraint('fk_collection_items_parent', ['parent_item_id'], 'collection_items', ['id'])
      .onDelete('set null')
      .execute();
